      ...
      data: function () {
        return {
          ...
          label1: {
            ...
            text: "Please Create a profile to continue",
            leftIcon: "",
            rightIcon: "",
            hidden: false,
            event: null,
          ...
          label4: {
            ...
            input: "",
            title: " Created with Unregistered DecSoft App Builder",
            text: "Please Chose a fouvarite Profile pic",
            leftIcon: "",
            rightIcon: "",
            hidden: false,
            event: null,
          ...
          button1: {
            ...
            active: false,
            leftIcon: "",
            rightIcon: "far fa-arrow-alt-circle-right",
            leftBadge: "",
            leftBadgeKind: "light",
...
if(views.view1.input1.value==""){
app.showAlert("Please fill in you name to continue because it is empty");

}
else if(views.view1.input5.value==""){
app.showAlert("Please enter your age to continue");
}
else{
app.replaceView("view2");

}
//app.sidebar.header = app.name;
...
// Place here the Javascript code to be executed in the "Load" event of the "image3" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "Click" event of the "image3" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List

app.sidebar.imageUrl=views.view1.image3.url;
...
// Place here the Javascript code to be executed in the "Click" event of the "image1" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE s
app.sidebar.imageUrl=views.view1.image1.url;
...
// Place here the Javascript code to be executed in the "Click" event of the "image2" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List

app.sidebar.imageUrl=views.view1.image2;
...
// Place here the Javascript code to be executed in the "Load" event of the "image4" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "Click" event of the "image4" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List

app.sidebar.imageUrl=views.view1.image4.url;
...
// Place here the Javascript code to be executed in the "Click" event of the "image5" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List

app.sidebar.imageUrl=views.view1.image5.url;
...
// Place here the Javascript code to be executed in the "Load" event of the "image6" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "Click" event of the "image6" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List

app.sidebar.imageUrl=views.view1.image6.url;
...
// Place here the Javascript code to be executed in the "ToggleClick" event of the "navbar1" visual native control
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "Show" event of the "view2" app view
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
app.sidebar.header =views.view1.input1.value;

app.sidebar.headerAlign = app.align.left;
//app.sidebar.imageUrl = 'app/images/Brand30.png';
...
window.appViews.view3 = Vue.component("view3", function (resolve, reject) {
  jQuery.get("app/views/html/view3.html", function (response) {
    resolve({
      props: ["app"],
      template: response,
      data: function () {
...
changeHandler: function (event) {
  ...
  self.value = self.items[$(event.target).
   children('option:selected').data('index')];
...
window.app = new Vue({
  ...
  router: new VueRouter({routes: [
    ...
    { path: '/view3', name: 'view3', component: window.appViews.view3, props: function (route) { app.query = $.isEmptyObject(route.query) ? false : route.query; } }
  ]}),
...
// Place here the Javascript code to be executed in the "Online" event of the "Sempala's Math_test" app
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "Offline" event of the "Sempala's Math_test" app
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
// Place here the Javascript code to be executed in the "SidebarItemClick" event of the "Sempala's Math_test" app
// Press the F1 key to get more information about this specific event
// Press the CTRL + SPACE shortcut to show the Editor Quick Code List
...
else if(app.sidebar.item.index==1){
app.showView("view3");
}
    },		
